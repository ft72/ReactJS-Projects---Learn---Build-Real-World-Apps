...
interface TVShowGenreProps {
  tvShowGenre: MovieGenreType[]; 
...
const Sidebar: FC<TVShowGenreProps> = ({
  tvShowGenre, 
  handleGenreChange,
  selectedGenre,
  handleFilterClick,
              ...
              <FormControl component="fieldset">
                <RadioGroup value={selectedSort} onChange={handleRadioChange}>
                  <FormControlLabel
                    value="popular"
                    control={<Radio />}
                    label={<Typography sx={{ fontSize: "1.5rem", color: "black" }}>Popular</Typography>}
                  />
                  <FormControlLabel
                    value="topRated"
                    control={<Radio />}
                    label={<Typography sx={{ fontSize: "1.5rem", color: "black" }}>Most Rated</Typography>}
                  />
                </RadioGroup>
              </FormControl>
            </AccordionDetails>
                    ...
                    <Chip
                      ...
                      sx={{
                        ...
                        backgroundColor: selectedGenre.includes(genre.id)
                          ? "primary.main"
                          : "default",
                        color: selectedGenre.includes(genre.id) ? "white" : "black",
                      }}
                    />
                  ))}
                </Box>
